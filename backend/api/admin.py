...
async def ingest_xml(
    ...
    try:
        ...
        # Сохранение информации о источнике
...
async def reindex(
    ...
    try:
        ...
        if success:
            # Переиндексация всех источников
            # В реальном приложении здесь нужно перечитать все источники из БД
            # и заново добавить их в Qdrant
